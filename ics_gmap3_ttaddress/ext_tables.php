...
$tempColumns = array (
    ...
    'tx_icsgmap3ttaddress_pictothumb' => array (        
        'exclude' => 0,        
        'label' => 'LLL:EXT:ics_gmap3_ttaddress/locallang_db.xml:tt_address_group.tx_icsgmap3ttaddress_pictothumb',        
        'config' => array (
            'type' => 'group',
            'internal_type' => 'file',
            'allowed' => 'gif,png,jpeg,jpg',    
...
t3lib_extMgm::addToAllTCAtypes('tt_address_group','tx_icsgmap3ttaddress_picto;;;;1-1-1, tx_icsgmap3ttaddress_pictothumb');
