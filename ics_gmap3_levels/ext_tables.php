...
$tempColumns['tx_icsgmap3levels_level']['config']['foreign_table_where'] = 'AND tx_icsgmap3levels_levels.deleted=0 AND tx_icsgmap3levels_levels.hidden=0 ORDER BY tx_icsgmap3levels_levels.sorting';
